...
class ExprVisitor(Protocol):
    ...
    def visit_str_expr(self, expr: "Str") -> Any: ...
...
class StmtVisitor(Protocol):
    ...
    def visit_memcpy_stmt(self, stmt: "Memcpy") -> Any: ...
    def visit_memmov_stmt(self, stmt: "Memmov") -> Any: ...
    def visit_button_stmt(self, stmt: "Button") -> Any: ...
    def visit_label_stmt(self, stmt: "Label") -> Any: ...
    def visit_change_label_text_stmt(self, stmt: "ChangeLabelText") -> Any: ...
